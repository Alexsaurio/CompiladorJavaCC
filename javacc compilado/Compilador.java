...
public class Compilador implements CompiladorConstants {
  ...
  final public void Vuelta() throws ParseException {
    if (jj_2_16(3)) {
      Declaraciones();
    } else {
      Sentencias();
  ...
  final public void Impresiones() throws ParseException {
  ...
  final public void datosImprimibles() throws ParseException {
    if (jj_2_21(3)) {
  ...
  final public void IGUALACIONes() throws ParseException {
    TipoDeDato();
    jj_consume_token(VARIABLE);
    jj_consume_token(IGUALACION);
    if (jj_2_24(3)) {
  ...
  final public void OperadorIncremental() throws ParseException {
    if (jj_2_41(3)) {
      jj_consume_token(INCREMENTO);
    } else if (jj_2_42(3)) {
      jj_consume_token(DECREMENTO);
  ...
  private boolean jj_3_40() {
    if (jj_scan_token(TYPEDOUBLE)) return true;
    return false;
  }

  private boolean jj_3_5() {
    if (jj_scan_token(LISTA)) return true;
    return false;
  }
  ...
  private boolean jj_3_39() {
    if (jj_scan_token(TYPEFLOAT)) return true;
    return false;
  }
  ...
  private boolean jj_3_14() {
    if (jj_3R_8()) return true;
    if (jj_scan_token(VARIABLE)) return true;
    if (jj_scan_token(LIMITANTE)) return true;
    return false;
  }
  ...
  private boolean jj_3_21() {
    if (jj_scan_token(VALCHAR)) return true;
    return false;
  }
  ...
  private boolean jj_3_43() {
    ...
    if (jj_scan_token(IGUALACION)) return true;
    if (jj_scan_token(VALINT)) return true;
    return false;
  }
  ...
  private boolean jj_3R_3() {
    if (jj_scan_token(IMPRESION)) return true;
    if (jj_scan_token(SALCOUT)) return true;
    if (jj_3R_10()) return true;
    return false;
  }

  private boolean jj_3_37() {
    if (jj_scan_token(TYPECHAR)) return true;
    return false;
  }

  private boolean jj_3_2() {
    if (jj_scan_token(FUNCIONMAT)) return true;
    return false;
  }
  ...
  private boolean jj_3_1() {
    if (jj_scan_token(ESTANDAR)) return true;
    return false;
  }
  ...
  private boolean jj_3_6() {
    if (jj_scan_token(DEFINIR)) return true;
    if (jj_scan_token(VARIABLE)) return true;
    if (jj_scan_token(VALINT)) return true;
    return false;
  }
  ...
  private boolean jj_3_35() {
    if (jj_scan_token(TYPELONG)) return true;
    return false;
  }
  ...
  private boolean jj_3_18() {
    if (jj_scan_token(CONIF)) return true;
    if (jj_scan_token(PARIZQ)) return true;
    if (jj_3R_9()) return true;
    return false;
  }
